...
const actionReportSchema=z.object({task:z.literal('ACTION_V1'),status:z.literal('ready'),model:z.string().min(1),revision:z.string().min(1),holdMargin:finite,generatedAt:z.string().datetime({offset:true}),source:z.string().min(1),
