...
Supported USD markets: `BTCUSD`, `ETHUSD`, `SOLUSD`, `XRPUSD`, `DOGEUSD`, `ADAUSD`, `AVAXUSD`, `LINKUSD`, `DOTUSD`, `LTCUSD`. Intervals remain 15, 60 and 240 minutes. Dogecoin uses Kraken’s `XDGUSD` market internally; clients always use `DOGEUSD`. All markets share the existing cache, quota and closed-candle validation rules.
